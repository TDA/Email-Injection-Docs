...
\begin{itemize}
	...
	This represents the total number of successful injections our system made. This includes the \dq{E-Mail Header Injections with `bcc' header}\,(1), \dq{`To header' injections alone}\,(3), and \dq{Unique `x-check' headers found in `nuser' e-mails}\,(7). This is the total number of vulnerabilities that we found.
