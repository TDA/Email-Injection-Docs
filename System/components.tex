...
\begin{table}[!htbp]
	\centering
	\input{System/tables}        
	\caption[Database - tables]{The different tables in our database.}
	\label{tab:dbtf}
\end{table}
