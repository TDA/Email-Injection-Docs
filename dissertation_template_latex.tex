...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\listadd{\titlelines}%
  {E-Mail Header Injections}             %<Enter the title of the dissertation
\listadd{\titlelines}%
  {An analysis of the World Wild Web}            % If you want to 
                                        %   split the title across lines,
                                        %   use another \listadd command for the 
                                        %   second line
\newcommand*\Author{Sai Prashanth Chandramouli}                      %<Enter your name; must match official transcript
...
\newcommand*\defdate{April 2016}                       %<Give April (written out fully) and year of 
                                        %   the oral defense
\listadd{\committeechair}{Dr. Adam Doupe}   %<Enter committee chair name; use \listadd for
...
\newcommand*{\chairlabel}{Chair}        %<If you have co-chairs, replace this text with 
                                        %   'Co-Chair'
\listadd{\committeemember}{Dr. Gail-Joon Ahn
} %<Enter committee member names; use \listadd for
\listadd{\committeemember}{Dr. Ziming Zhao} %   additional names
\newcommand*{\gradmonth}{May}         %<Enter the graduation date; month can only be: 
                                        %  May, August, or December
\newcommand*{\gradyear}{2016}           %<Enter the graduation year, e.g. 2014
